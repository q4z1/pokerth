...
echo "Updating ..."
cd botfiles
curl -O https://bbc.pokerth.net/exp3/bbcbot/bbcupfinal_settings.txt
curl -O https://bbc.pokerth.net/exp3/bbcbot/gameslist.txt
curl -O https://bbc.pokerth.net/exp3/bbcbot/husctest2_settings.txt
curl -O https://bbc.pokerth.net/exp3/bbcbot/mcupfinal_settings.txt
curl -O https://bbc.pokerth.net/exp3/bbcbot/newweclist.txt
curl -O https://bbc.pokerth.net/exp3/bbcbot/step2_settings.txt
curl -O https://bbc.pokerth.net/exp3/bbcbot/wecgfinal_settings.txt
...
curl -O https://bbc.pokerth.net/exp3/bbcbot/minidb.txt
curl -O https://bbc.pokerth.net/exp3/bbcbot/step1_settings.txt
curl -O https://bbc.pokerth.net/exp3/bbcbot/step4_settings.txt
curl -O https://bbc.pokerth.net/exp3/bbcbot/wec_settings.txt
echo "Done."
